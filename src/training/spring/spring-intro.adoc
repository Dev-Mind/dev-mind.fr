:doctitle: Spring in practice : intro & boot (EN)
...
* [.small .small-block]#Option *--continuous* allows to let the application running. App will be updated as soon as you will make changes in your code AND WHEN this code will be recompiled#
