...
[.small]#1.We load a Junit5 extension to capture output (log generated by your app) +
...
[.small .small-block]#1. We use `SpringExtension` to link our test to Spring. With this annotation a Spring Context will be loaded when this test will run +
