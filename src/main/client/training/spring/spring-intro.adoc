...
[.small .small-block]#> https://dev-mind.fr/help.pdf#
...
image:../../img/training/spring-intro/springboot-init191.png[size=90%]
...
[.small]#<1> Adds the Spring Boot plugin to be able to manage your app with Gradle +
...
[.small .small-block]#1.{nbsp} `spring-boot-starter-web` is a starter used to create WebApp +
{nbsp} +
