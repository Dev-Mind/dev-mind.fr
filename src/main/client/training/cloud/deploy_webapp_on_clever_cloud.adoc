...
To fix it you can follow
2:18 PM



https://medium.com/@akash1233/change-file-permissions-when-working-with-git-repos-on-windows-ea22e34d5cee[this article]. Or execute this command
