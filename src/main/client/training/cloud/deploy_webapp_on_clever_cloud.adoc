...
You can define environment variables and it's important for us. We need to override the default Java Version used by Clever Cloud. For that add a new environment variable called `CC_JAVA_VERSION` and with a value equals to 17.
