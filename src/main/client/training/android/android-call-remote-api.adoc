...
Dev-Mind website expose simple non secured URLs to read Rooms ans their windows or heaters. This simple API can be used for this lab

* https://dev-mind.fr/training/android/rooms
* https://dev-mind.fr/training/android/rooms/id (id must be replaced by the value of a window id)
...
* https://dev-mind.fr/training/android/heaters
* https://dev-mind.fr/training/android/heaters/id (id must be replaced by the value of a window id)

You can also used your own Spring API if you followed Spring course or my implementation available on http://automacorp-client-for-android.cleverapps.io/swagger-ui/index.html. This app is secured by basic auth and you can the username `user` and his password `password`.
