...
class WindowService {
    ...
    companion object {
        ...
        val WINDOWS: List<WindowDto> = listOf(
            WindowDto(1, "Entry Window", ROOMS[0], Status.CLOSE),
            WindowDto(2, "Back Window", ROOMS[0], Status.CLOSE),
            WindowDto(3, "Sliding door", ROOMS[1], Status.OPEN),
            WindowDto(4, "Window 1", ROOMS[2], Status.CLOSE),
            WindowDto(5, "Window 2", ROOMS[2], Status.CLOSE),
        )
    }
