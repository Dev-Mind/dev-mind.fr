...
* one for the app module, *Module: automacorp.app.*

Each module has its own *build.gradle* file, but this project currently has just one module.

If you need to use external libraries you will declare this dependencies in *build.gradle (Mocule: automacorp.app)* If you want to configure android plugin (APi version, SDK version) you will update *build.gradle (Project: automacorp)*
